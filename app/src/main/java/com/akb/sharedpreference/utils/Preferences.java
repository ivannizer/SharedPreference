package com.akb.sharedpreference.utils;
...
import com.akb.sharedpreference.model.UserModel;

public class Preferences {


    private static final String PREF_SESSION = "com.akb.sharedpreference.session";
